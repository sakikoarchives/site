$(function () {
    ...
    $('h3 .title').html(computer_.MiscText.AbyssTitle[lang2] + "<color style='font-size: 26px;'><br>" + (lang == "CH" ? '原神 <b>' : 'Genshin Impact <b>') + VER_GI + "</b></color>")
    ...
    function renderResultPre() {
        ...
        Phases.forEach(function (item, i) {
            var a = {
                p_name: _computer_.SpiralAbyssPhaseConfig[item][lang],
